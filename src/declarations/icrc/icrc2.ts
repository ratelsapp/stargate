...
export type ApproveResult = { Ok: TxIndex } | { Err: ApproveError };
export interface Ledger {
  ...
  icrc1_transfer: ActorMethod<
    ...
    TransferResult
  >;
  icrc2_allowance: ActorMethod<[{ account: Account; spender: Principal }], Tokens>;
...
export type TransferFromError =
  ...
  | { TooOld: null }
  | { InsufficientFunds: { balance: Tokens } };
export type TransferFromResult = { Ok: TxIndex } | { Err: TransferFromError };
